...
{
    public partial class AktivitasTambah : Form
    {
        private int id_penanaman;

        public AktivitasTambah(int id_penanaman)
        {
            InitializeComponent();
            ...
            this.id_penanaman = id_penanaman;
        }

        private void AktivitasTambah_Load(object sender, EventArgs e)
        {
        ...
        {
            if (
                inputJenisAktivitas.SelectedItem == null
            )
            {
                MessageBox.Show(
            ...
            try
            {
                ...
                bool isAdded = AktivitasController.AddAktivitas(
                    new AktivitasModel
                    {
                        IdJenisAktivitas = idJenisAktivitas,
                        IdPenanaman = id_penanaman,
                        IdAkun = UserSession.CurrentUser.IdAkun,
                        Waktu = Waktu,
                ...
                {
                    MessageBox.Show(
                        "Gagal menambahkan Aktivitas. Silakan coba lagi.",
                        "Error",
                        MessageBoxButtons.OK,
